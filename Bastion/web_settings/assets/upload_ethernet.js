...
const url = "/web_settings/" + UPLOAD_JSON_FILENAME;
const PATH_FOR_NET = "/web_settings/api/getNet.api";
...
docReady(function() {
	window.onload = getJSONfromDevice("/web_settings/" + UPLOAD_JSON_FILENAME, CallBackFunction),
