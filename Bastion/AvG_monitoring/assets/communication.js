...
function addRow(CID, Name, Address, Status) {
    ...
    if (Status === "Нет статуса"){
        ...
        "<i class='fas fa-wifi' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top' title='Канал телефон'></i>"+
        "<i class='fas fa-wifi' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top' title='Канал радио'></i>"+
        "<i class='fas fa-wifi' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top' title='Канал LAN IP'></i>";
        ...
        if(filteredItems[0] !== undefined){
            ...
            cellStatus.childNodes[0].style.color = "#b3b3b3";
        }
        query = "Канал Телефон";
        ...
        if(filteredItems[0] !== undefined){
            ...
            cellStatus.childNodes[1].style.color = "#b3b3b3";
        }
        query = "Канал Радио";
        filteredItems = Status.filter(item => `${item.t}`.includes(query));
        if(filteredItems[0] !== undefined){
        ...
        if(filteredItems[0] !== undefined){
            ...
            cellStatus.childNodes[3].style.color = "#b3b3b3";
        }
    }
}
