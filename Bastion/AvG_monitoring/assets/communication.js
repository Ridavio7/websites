...
function callbackGetFiltObjectList(err, respobj){
    if(err){
        ...
        if (chose_box == "Фильтр"){
            funcGetObjectList();
        } else if(chose_box == "Связь есть"){
            funcFiltList(respobj, "Cвязь есть");
        } else if(chose_box == "Связь пропала") {
            funcFiltList(respobj, "Связь пропала");
        } else if(chose_box == "Давно нет связи") {
            funcFiltList(respobj, "Давно нет связи");
        }
    }
