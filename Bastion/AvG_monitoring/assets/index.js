...
let   tid = 0, userId = 0, sat = 0, ts = 0, err, data_line = [], count_obj = 0;
...
function funcProcessGetDashboardInfoFourth( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfo(err, respobj, "db_power");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoThird( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfo(err, respobj, "db_communication");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoSecond( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfo(err, respobj, "db_alarm");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoFirst( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfo(err, respobj, "db_objects");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function addRow(CID, Name, Address, Status) {
    ...
    if (Status === "Нет статуса"){
        ...
        "<i class='fas fa-tools' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top'></i>"+
        "<i class='fas fa-lock' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top'></i>"+
