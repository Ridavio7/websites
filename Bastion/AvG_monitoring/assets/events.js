...
function addRowMes(date, CID, mes) {
    ...
    if (mes.indexOf("Закрыл") >= 0){
        cellStatus.innerHTML = "<i class='fas fa-lock' style='color: #1cc88a;' data-toggle='tooltip' data-placement='top'></i>";
    } else if (mes.indexOf("Откры") >= 0){
        cellStatus.innerHTML = "<i class='fas fa-unlock' style='color: #4e73df;' data-toggle='tooltip' data-placement='top'></i>";
    }  else if (mes === "Закрыт"){
        cellStatus.innerHTML = "<i class='fas fa-lock' style='color: #1cc88a;' data-toggle='tooltip' data-placement='top'></i>";
    } else {
        cellStatus.innerHTML = "<i class='fas fa-wrench' style='color: #b3b3b3;' data-toggle='tooltip' data-placement='top'></i>";
    }
...
button_up.addEventListener('click', function() {
    block_obj_list.scrollTo({ top: 0, behavior: 'smooth'  });
});

button_down.addEventListener('click', function() {
    //block_alarm_list.scrollTo({ bottom: 0, behavior: 'smooth' });
    block_obj_list.scrollTop = block_obj_list.scrollHeight;
});
