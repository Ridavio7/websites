...
function callbackGetDashboardInfoComm(err, respobj, db_id){
    if(err){
        //Error!
    } else {
...
function funcProcessGetDashboardInfoCommRadio( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_comm_radio");
    } else {
...
function funcProcessGetDashboardInfoCommPhone( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_comm_phone");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoCommIP( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_comm_ip");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoCommMain( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_comm_main");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoPower( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_power");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoObj( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_obj");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoAlarm( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_alarm");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoStatus( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_status");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
...
function funcProcessGetDashboardInfoFifth( result, respobj ){
    ...
    if( respobj.pn == "1" ){
        ...
        callbackGetDashboardInfoComm(respobj.sErr, respobj, "canvas_fault");
    } else {
        console.log( "Не определено: " + respobj.pn );
    }
}
